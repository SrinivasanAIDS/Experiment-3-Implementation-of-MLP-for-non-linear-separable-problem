...
The inner layers for deeper processing of the inputs are known as hidden layers. The hidden layers are not dependent on any other layers. This architecture is known as 
...
```
### OUTPUT :
![image](https://user-images.githubusercontent.com/103049243/235456861-73da0276-183c-47fa-a6eb-da96d61b58de.png)
